...
const problems = [{
  ...
  icon: HelpCircle,
  title: "Selbstzweifel",
  description: "Ständiges Hinterfragen der eigenen Fähigkeiten."
}];
  ...
  return <section id="problems" className="bg-white py-[50px]">
      <div className="container mx-auto px-3 md:px-40">
        ...
        duration: 0.6
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Womit sich andere rumschlagen müssen</h2>
