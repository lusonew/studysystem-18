  ...
  return <section id="pricing" className="py-24 bg-white">
      <div className="container mx-auto px-3 md:px-40">
        ...
        <div className="max-w-none mx-auto">
          <PricingCard title="Study System PRO" price={<div className="flex flex-col items-center gap-1"><div className="flex items-center gap-2"><span className="text-2xl font-medium text-gray-400 line-through">109€</span> <span className="text-sm text-gray-500">Einmalig</span></div><div className="text-2xl font-bold text-red-600">76,30€</div></div>} features={proPricingFeatures} imageUrl="/lovable-uploads/2d367a7d-0631-407d-b870-021d9b5db458.png" ctaUrl="https://pay.studysystem.de/b/bIY8zygDgfm9c245ko" bestSeller={true} className="bg-gradient-to-br from-amber-50 to-white border-amber-200" originalValue="199€" imageClassName="!scale-100" additionalLink={{
