  ...
  return <section id="pricing" className="py-24 bg-white">
      <div className="container mx-auto px-3 md:px-6 lg:px-20 xl:px-40">
        ...
        <div className="max-w-none mx-auto">
          <PricingCard title="Study System PRO" price={<div className="flex flex-col items-center gap-1"><div className="flex items-center gap-3"><span className="line-through text-3xl text-gray-400">109€</span><span className="text-2xl font-medium text-green-600">87€</span> <span className="text-sm text-gray-500">Einmalig</span></div><div className="bg-black text-white px-4 py-1.5 rounded-full text-xs font-semibold mt-2">Black Friday: -20% Rabatt</div></div>} features={proPricingFeatures} imageUrl="/lovable-uploads/dashboard.webp" ctaUrl="https://pay.studysystem.de/b/5kQ3cv3zO9WG6s4f4l3cc0a?prefilled_promo_code=BFStudySystemPRO" bestSeller={true} className="bg-gradient-to-br from-amber-50 to-white border-amber-200" imageClassName="!scale-100" additionalLink={{
