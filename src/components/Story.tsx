      ...
      <motion.div initial={{
        ...
        <div className="flex flex-col lg:flex-row items-center gap-2.5">
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-600 mb-4 text-lg font-normal">Wie viele Studierende, hatte ich am Anfang große Probleme: Bei Klausuren durchgefallen, durchgehend gestresst und Zweifel, ob ich jemals den Abschluss schaffen würde.</p>
