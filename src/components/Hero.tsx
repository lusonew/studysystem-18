  ...
  return <section className={`
      ...
      <div className="container mx-auto px-3 md:px-40">
        <div className="text-center mb-12">
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-2">Bring System in dein Studium und studiere smarter als alle anderen</h1>
        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-12">
          ...
          delay: 0.2
            ...
            <img src="/lovable-uploads/96552dbd-692e-4a8a-9d1e-ed3218b4f13c.png" alt="Study System Dashboard" width={800} height={600} className="w-full h-auto" loading="eager" fetchPriority="high" />
          </motion.div>
        </div>
