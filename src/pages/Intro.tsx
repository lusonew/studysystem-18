...
const Intro = () => {
  return <div className="min-h-screen bg-gradient-to-br from-amber-50 via-amber-50/50 to-white">
      {/* Hero Section */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          delay: 0.2
            ...
            <div className="relative max-w-4xl mx-auto">
                ...
                <iframe src="https://www.loom.com/embed/d1ce017421504aa188f927403ca1b109" title="Study System PRO Einführung" className="w-full h-full rounded-2xl" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
            </div>
          </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="border-2 border-amber-100 hover:border-amber-200 transition-colors">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600">Erstelle dein Konto über den Link in der Mail.</p>
                </CardContent>
              </Card>
          ...
          delay: 0.6
            ...
            <p className="text-lg text-gray-600">
              ...
              <a href="mailto:support@luisnewton.de" className="text-amber-600 hover:text-amber-700 underline">
